...
const Teams = () => {
  return (
    <motion.div
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="flex flex-col items-center gap-7 px-4 sm:px-12 lg:ox24
     xl:px-40 pt-30 text-gray-800 dark:text-white"
    >
      <Title
        title="Nuestro Equipo"
        desc="Un equipo apasionado de expertos digitales dedicados al éxito de tu marca."
      />
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">
        {teamData.map((team, index) => (
          ...
          >
            <img src={team.image} className="w-12 h12 rounded-full" alt="" />
