...
const Hero = () => {
  return (
    <div
      id="hero"
      className="flex flex-col items-center gap-6 py-24 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white"
    >
      <motion.div
      ...
      >
        <img className="w-20" src={assets.group_profile} alt="Trusted" />
        <p>Clientes Satisfechos 10k+</p>
      </motion.div>
      ...
      >
        Donde la imaginación se convierte en{" "}
      ...
      >
        Transformamos la creatividad en soluciones digitales que conectan.
      </motion.p>
