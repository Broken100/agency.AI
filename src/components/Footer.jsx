...
const Footer = ({ theme }) => {
  return (
    ...
    >
      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <p className="max-w-md">
            Diseñamos experiencias digitales que transforman ideas en
            resultados.
          </p>
        ...
        >
          ...
          <p className="text-sm mt-2 mb-6">
            Mantente al día con nuestras novedades, tendencias y herramientas
            digitales cada semana.
          </p>
      ...
      >
        <p>Copyright 2025 © Code&Click - All Right Reserved.</p>
